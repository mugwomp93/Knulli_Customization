...
There also are a couple of other versions of the Neo Geo-style logo available (circle logo, plain black background), but this one is my favorite. The background image in the Neo Geo bootlogo is adapted from [ivan cristina's vectorized version](https://github.com/ivancristina/ArcadeSketches) of [angel77lopez's arcade logos artwork](https://forums.pimoroni.com/t/new-artwork-for-picade-cabinet/2618/495). 
